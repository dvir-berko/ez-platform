...
import { useSidebarPinState, Content, CatalogIcon, DocsIcon } from '@backstage/core-components';
import { fetchApiRef, discoveryApiRef, useApi } from '@backstage/core-plugin-api';
import { ApiBlueprint, PageBlueprint, createExtensionInput, NavItemBlueprint, createFrontendPlugin, configApiRef } from '@backstage/frontend-plugin-api';
...
import { searchTranslationRef as searchTranslationRef$1 } from './translation.esm.js';
    ...
    return originalFactory({
      ...
      loader: async () => {
        ...
        const Component = () => {
          ...
          return /* @__PURE__ */ jsx(Content, { children: /* @__PURE__ */ jsxs(Grid, { container: true, direction: "row", children: [
...
var alpha = createFrontendPlugin({
  pluginId: "search",
  title: "Search",
  icon: /* @__PURE__ */ jsx(SearchIcon, { fontSize: "inherit" }),
...
const searchTranslationRef = searchTranslationRef$1;

export { alpha as default, searchApi, searchNavItem, searchPage, searchTranslationRef };
