...
class AuthHelper {
  ...
  static fromConfig(config, options) {
    ...
    const jwtHeaderName = config.getOptionalString("jwtHeaderName") ?? CF_JWT_HEADER;
    const authorizationCookieName = config.getOptionalString("authorizationCookieName") ?? COOKIE_AUTH_NAME;
