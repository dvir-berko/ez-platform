...
function EntityProcessingErrorsPanel() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: value.items.map((ancestorError, index) => /* @__PURE__ */ jsxs(Box, { mb: "2", children: [
    stringifyEntityRef(entity) !== stringifyEntityRef(ancestorError.entity) && /* @__PURE__ */ jsxs(Box, { p: "2", children: [
