...
import { T as TechDocsAddonLocations, a as TechDocsAddonOptions, b as TechDocsMetadata, c as TechDocsEntityMetadata } from './types/types.d-BlEjzAuE.js';
...
export { SHADOW_DOM_STYLE_LOAD_EVENT, TECHDOCS_ADDONS_KEY, TECHDOCS_ADDONS_WRAPPER_KEY, TechDocsAddonLocations, TechDocsAddonOptions, TechDocsAddons, TechDocsEntityMetadata, TechDocsMetadata, TechDocsReaderPageProvider, TechDocsShadowDom, buildTechDocsURL, createTechDocsAddonExtension, getEntityRootTechDocsPath, techdocsApiRef, techdocsStorageApiRef, toLowercaseEntityRefMaybe, useShadowDomStylesLoading, useShadowRoot, useShadowRootElements, useShadowRootSelection, useTechDocsAddons, useTechDocsReaderPage };
export type { SyncResult, TechDocsApi, TechDocsReaderPageProviderProps, TechDocsReaderPageProviderRenderFunction, TechDocsReaderPageValue, TechDocsShadowDomProps, TechDocsStorageApi };
