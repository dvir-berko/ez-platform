...
class BitbucketCloudClient {
  ...
  searchCode(workspace, query, options, pagelen) {
    const workspaceEnc = encodeURIComponent(workspace);
    return new pagination.WithPagination(
  ...
  async request(req) {
    ...
    return fetch__default.default(req, { headers }).then((response) => {
      if (!response.ok) {
        throw new Error(
...
//# sourceMappingURL=BitbucketCloudClient.cjs.js.map
