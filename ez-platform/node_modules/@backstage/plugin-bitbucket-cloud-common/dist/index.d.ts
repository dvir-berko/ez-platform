...
declare class WithPagination<TPage extends Models.Paginated<TResultItem>, TResultItem> {
    ...
    private readonly pagelen?;
    constructor(createUrl: (options: PaginationOptions) => URL, fetch: (url: URL) => Promise<TPage>, pagelen?: number);
...
declare class BitbucketCloudClient {
    ...
    private constructor();
    searchCode(workspace: string, query: string, options?: FilterAndSortOptions & PartialResponseOptions, pagelen?: number): WithPagination<Models.SearchResultPage, Models.SearchCodeSearchResult>;
...
export { BitbucketCloudClient, Events, Models, WithPagination };
export type { FilterAndSortOptions, PaginationOptions, PartialResponseOptions, RequestOptions };
